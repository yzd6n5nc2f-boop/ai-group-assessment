        ...
        return (
          <div className="card bg-base-100 shadow-xl border border-[#434343]">
            <div className="card-body text-center">
              <h2 className="card-title text-2xl primary-color mb-4">Assessment Submitted Successfully!</h2>
              <p className="mb-4">Thank you for completing the AI Fluency Assessment.</p>
              {formData.email && (
                <p className="mb-4">Your personalized AI Fluency Profile PDF will be sent to {formData.email} shortly.</p>
              )}
              <button 
                className="btn btn-primary"
                onClick={() => {
